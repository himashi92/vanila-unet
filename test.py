...
class Test(object):
    ...
    def _init_logger(self):
        ...
        self.model_name = 'UNet/NestedUnet'

        log_dir = 'logs/' + self.model_name + '/' + opt.dataset + '/test' + '/{}'.format(
        ...
        self.model_load_path = 'logs/Unet/NestedUnet/tnbc/train/20200920-133900/Checkpoints/Model_299_gen.pth'
